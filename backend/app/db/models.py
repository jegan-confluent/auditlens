...
class AuditEvent(Base):
    ...
    at_justification: Mapped[str | None] = mapped_column(Text, nullable=True)
    at_operator: Mapped[str | None] = mapped_column(String(255), nullable=True)
    ...
    original_principal: Mapped[str | None] = mapped_column(String(512), nullable=True)
    assigned_principals: Mapped[str | None] = mapped_column(Text, nullable=True)
